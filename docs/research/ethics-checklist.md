# Ethics Checklist — UniSchedule AI Primary Data Collection
...
This checklist supports ethics confirmation before launching the **survey** (target n ≥ 20) and **semi-structured interviews** (3–5 participants) described in [`06-evaluation-security-ethics.md`](../supervisor-submission/06-evaluation-security-ethics.md).

---

## 2. University of Canterbury pathway
...
| Store approval reference number in `docs/PROJECT-NOTES.md` §13 | e.g. `HEC-2026-XXXX` |

**Ask supervisor:** "Is my survey + 3–5 interviews exempt, or do I need full HEC application?"

---

## 3. Participant information sheet (summary)
...
## 8. Sign-off (complete after supervisor meeting)
...
| Ethics reference logged in PROJECT-NOTES §13 | ☐ | |
